...
@interface NEUIConnectListView () <UITableViewDataSource, UITableViewDelegate> {
  CGRect _preRect;
}
...
@property(nonatomic, strong) NEUIConnectAlertView *connectAlertView;
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  NEUIConnectListCell *cell = [NEUIConnectListCell cellWithTableView:tableView
...
- (UITableView *)listView {
  if (!_listView) {
    ...
    [tableview registerClass:[NEUIConnectListCell class]
        forCellReuseIdentifier:[NEUIConnectListCell description]];
