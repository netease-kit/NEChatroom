...
@interface NEUIActionSheetNavigationController ()

// 圆角遮罩
@property(nonatomic, strong) CAShapeLayer *navigationBarMask;

// 转场动画代理
@property(nonatomic, strong) NEUIActionSheetTransitioningDelegate *transitioning;

@end

@implementation NEUIActionSheetNavigationController
...
- (instancetype)initWithRootViewController:(UIViewController *)rootViewController {
  ...
  if (self) {
    ...
    self.transitioning = [[NEUIActionSheetTransitioningDelegate alloc] init];
