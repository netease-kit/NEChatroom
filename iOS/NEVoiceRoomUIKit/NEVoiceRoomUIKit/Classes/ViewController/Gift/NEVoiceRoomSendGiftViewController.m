...
#import "NESheetNavigationController.h"
...
/// 代理
@property(nonatomic, weak) id<NEVoiceRoomSendGiftViewtDelegate> delegate;
/// 礼物展示视图
...
+ (void)showWithTarget:(id<NEVoiceRoomSendGiftViewtDelegate>)target
  ...
  vc.delegate = target;
  NESheetNavigationController *nav =
      [[NESheetNavigationController alloc] initWithRootViewController:vc];
