...
@interface NEUIBackgroundMusicVC () <UITableViewDataSource, UITableViewDelegate>
// 列表
...
// 伴音
@property(nonatomic, copy) NSArray<NEUIBackgroundMusicModel *> *backgroundMusics;
@property(nonatomic, strong) NEUIChatroomContext *context;
@end

@implementation NEUIBackgroundMusicVC
...
- (void)loadView {
  ...
  [self.tableView registerClass:NEUIBackgroundMusiceCell.class forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  NEUIBackgroundMusiceCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
- (NSArray<NEUIBackgroundMusicModel *> *)backgroundMusics {
