...
@interface NEVoiceRoomReachability ()
...
#pragma unused(target)
  ...
  NEVoiceRoomReachability *reachability = ((__bridge NEVoiceRoomReachability *)info);
...
@implementation NEVoiceRoomReachability

#pragma mark - Class Constructor Methods

+ (instancetype)reachabilityWithHostName:(NSString *)hostname {
  return [NEVoiceRoomReachability reachabilityWithHostname:hostname];
}
...
- (NEVoiceRoomNetworkStatus)currentReachabilityStatus {
  if ([self isReachable]) {
...
- (NSString *)currentReachabilityString {
  NEVoiceRoomNetworkStatus temp = [self currentReachabilityStatus];
...
- (void)reachabilityChanged:(SCNetworkReachabilityFlags)flags {
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    [[NSNotificationCenter defaultCenter]
        postNotificationName:kNEVoiceRoomReachabilityChangedNotification
                      object:self];
  });
}
