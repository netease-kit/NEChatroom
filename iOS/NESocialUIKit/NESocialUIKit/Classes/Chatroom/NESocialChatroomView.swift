...
@objcMembers public class NESocialChatroomMessage: NSObject {
  ...
  internal var attributedContent: NSAttributedString?
  ...
  internal func addIcon(mutableString: NSMutableAttributedString) {
    // 如果有头像就把头像加进去
    if let icon = icon {
...
class NESocialChatroomCell: UITableViewCell {
  ...
  internal var message: NESocialChatroomMessage? {
    get {
      _message
    }
    set {
