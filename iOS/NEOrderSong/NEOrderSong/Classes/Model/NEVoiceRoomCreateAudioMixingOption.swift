...
public enum NEOrderSongAudioStreamType: Int {
  /// 音频流主流
  case main = 0
  /// 音频流辅流
  case sub
...
@objcMembers
public class NEOrderSongCreateAudioMixingOption: NSObject {
  /**
  ...
  /**
   伴音跟随音频主流还是辅流，默认跟随主流
   */
  public var sendWithAudioType: NEOrderSongAudioStreamType = .main
