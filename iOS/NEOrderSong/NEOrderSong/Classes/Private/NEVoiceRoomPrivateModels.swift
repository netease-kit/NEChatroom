...
@objcMembers
/// 直播信息
internal class _NEOrderSongListResponse: NSObject, Codable {
  var pageNum: Int?
  var pageSize: Int?
  var size: Int?
  var startRow: Int?
...
@objcMembers
/// 直播信息
internal class _NEOrderSongInfoResponse: NSObject, Codable {
  var anchor: _NECreateLiveAnchor?
  var live: _NECreateLiveLive?
}

/// 设备参数 判断走串行还是实时合唱的参数
internal class _NEOrderSongDeviceParam: Codable {
  /// 播放延时，单位：ms
...
internal enum _NEOrderSongMusicOperationType: Int {
  // 暂停
  case pause = 2
  // 恢复
  case resume = 1
...
@objcMembers
internal class _NEOrderSongRewardTop: NSObject, Codable {
  var userUuid: String?
  var userName: String?
  var avatar: String?
  var rewardCoin: Int?
...
@objcMembers
internal class _NEOrderSongAnchorReward: NSObject, Codable {
  var userUuid: String?
...
@objcMembers
internal class _NEOrderSongRewardMessage: NSObject, Codable {
  var subCmd: Int?
  var type: Int?
