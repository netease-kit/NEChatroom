...
extension CALayer {
  ...
  @nonobjc
  func setupLayerHierarchy(for layers: [LayerModel],
    ...
    func makeParentTransformLayer(childLayerModel: LayerModel,
                                  childLayer: CALayer,
  ...
  fileprivate func maskLayer(for matteLayerModel: LayerModel,
                             type: MatteType,
                             context: LayerContext)
    throws -> CALayer? {
    switch type {
