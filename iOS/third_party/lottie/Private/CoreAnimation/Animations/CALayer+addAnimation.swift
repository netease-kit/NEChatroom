...
extension CALayer {
  ...
  @nonobjc
  func addAnimation<KeyframeValue, ValueRepresentation: Equatable>(for property: LayerProperty<ValueRepresentation>,
  ...
  @nonobjc
  private func defaultAnimation<KeyframeValue, ValueRepresentation>(for property: LayerProperty<ValueRepresentation>,
                                                                    keyframes: ContiguousArray<Keyframe<KeyframeValue>>,
                                                                    value keyframeValueMapping: (KeyframeValue) throws -> ValueRepresentation,
                                                                    context: LayerAnimationContext)
    throws -> CAAnimation? {
  ...
  @nonobjc
  private func customizedAnimation<ValueRepresentation>(for property: LayerProperty<ValueRepresentation>,
                                                        context: LayerAnimationContext)
    ...
    guard
      ...
      let customKeyframes = try context.valueProviderStore.customKeyframes(
        ...
        for: AnimationKeypath(keys: context.currentKeypath.keys + customizableProperty.name.map(\.rawValue)),
        context: context
      )
    else { return nil }
  ...
  private func singleKeyframeAnimation<ValueRepresentation>(for property: LayerProperty<ValueRepresentation>,
  ...
  private func animationGroup<KeyframeValue, ValueRepresentation>(for property: LayerProperty<ValueRepresentation>,
  ...
  private func keyframeAnimation<KeyframeValue, ValueRepresentation>(for property: LayerProperty<ValueRepresentation>,
  ...
  private func path<KeyframeValue>(keyframes positionKeyframes: [Keyframe<KeyframeValue>],
  ...
  private func validate<ValueRepresentation>(values: inout [ValueRepresentation],
