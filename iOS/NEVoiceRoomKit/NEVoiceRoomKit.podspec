...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mayajie@corp.netease.com.com/NEVoiceRoomKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gingerjin1993@gmail.com' => 'mayajie@corp.netease.com' }
  s.source           = { :git => 'https://github.com/mayajie@corp.netease.com/NEVoiceRoomKit.git', :tag => s.version.to_s }
