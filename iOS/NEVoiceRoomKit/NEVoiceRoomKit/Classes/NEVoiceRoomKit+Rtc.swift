  ...
  func enableEarBack(_ volume: UInt32) -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "Failed to enable earback. Code: \(code)")
      }
      return code
    }
  }
  ...
  func disableEarBack() -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "Failed to disable earback. Code: \(code)")
      }
      return code
    }
  }
  ...
  func startAudioMixing(_ option: NEVoiceRoomCreateAudioMixingOption) -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "Failed to start audio mixing. Code: \(code)")
      }
      return code
    }
  }
  ...
  func stopAudioMixing() -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "Failed to stop audio mixing. Code: \(code)")
      }
      return code
    }
  }
  ...
  func pauseAudioMixing() -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "Failed to pause audio mixing. Code: \(code)")
      }
      return code
    }
  }
  ...
  func playEffect(_ effectId: UInt32, option: NEVoiceRoomCreateAudioEffectOption) -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "Failed to play effect. Code: \(code)")
      }
      return code
    }
  }
  ...
  func pauseEffect(effectId: UInt32) -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "❌Failed to Pause effect. Code: \(code)")
      }
      return code
    }
  }
  ...
  func resumeEffect(effectId: UInt32) -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "❌Failed to Resume effect. Code: \(code)")
      }
      return code
    }
  }
  ...
  func stopAllEffects() -> Int {
    ...
    return Judge.syncCondition {
      ...
      if code == 0 {
        ...
        NEVoiceRoomLog.errorLog(kitTag, desc: "Failed to stop all effects. Code: \(code)")
      }
      return code
    }
  }
