...
/// 唱歌 相关操作接口
/// 独唱、合唱
internal class NEVoiceRoomAudioPlayService: NSObject, NERoomListener {
  ...
  internal var callback: NEVoiceRoomPlayStateChangeCallback?
  // 歌唱者类型
  internal var singer: NEVoiceRoomSinger = .audience
