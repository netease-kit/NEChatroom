...
@objcMembers
/// 直播信息
internal class _NEVoiceRoomListResponse: NSObject, Codable {
  var pageNum: Int?
  var pageSize: Int?
  var size: Int?
  var startRow: Int?
...
/// 设备参数 判断走串行还是实时合唱的参数
internal class _NEVoiceRoomDeviceParam: Codable {
  /// 播放延时，单位：ms
...
internal enum _NEVoiceRoomMusicOperationType: Int {
  // 暂停
  case pause = 2
  // 恢复
  case resume = 1
...
@objcMembers
internal class _NEVoiceRoomRewardTop: NSObject, Codable {
  var userUuid: String?
  var userName: String?
  var avatar: String?
  var rewardCoin: Int?
...
@objcMembers
internal class _NEVoiceRoomAnchorReward: NSObject, Codable {
  var userUuid: String?
  var pkRewardTotal: Int?
  var rewardTotal: Int?
  var pkRewardTop: [_NEVoiceRoomRewardTop]?
}

@objcMembers
internal class _NEVoiceRoomRewardMessage: NSObject, Codable {
  var subCmd: Int?
  var type: Int?
  ...
  var giftId: Int?
  var memberTotal: Int?
  var anchorReward: _NEVoiceRoomAnchorReward?
  var otherAnchorReward: _NEVoiceRoomAnchorReward?
}
