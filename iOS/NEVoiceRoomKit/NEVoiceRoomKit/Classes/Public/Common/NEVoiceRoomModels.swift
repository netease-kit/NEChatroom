...
public class NEVoiceRoomInfo: NSObject {
  ...
  internal init(liveInfo: _NEVoiceRoomInfoResponse?) {
...
public class NEVoiceRoomRtcLastmileProbeTest: NSObject {
  ...
  internal init(result: NERoomRtcLastmileProbeResult) {
...
public class NEVoiceRoomRtcLastmileProbeOneWayResult: NSObject {
  ...
  internal convenience init(_ result: NERoomRtcLastmileProbeOneWayResult) {
    self.init()
