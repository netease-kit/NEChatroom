...
@interface NEListenTogetherUIActionSheetPresentationController () <UIGestureRecognizerDelegate>
...
@implementation NEListenTogetherUIActionSheetPresentationController
