...
final class ZipArchive: Sequence {
  ...
  static let endOfCentralDirectoryStructSignature = 0x0605_4B50
  ...
  static func makeBackingConfiguration(for url: URL) -> BackingConfiguration? {
    ...
    guard
      ...
      let (eocdRecord, zip64EOCD) = ZipArchive.scanForEndOfCentralDirectoryRecord(in: archiveFile)
    else {
      return nil
    }
...
extension ZipArchive {
  ...
  static let zip64EOCDRecordStructSignature = 0x0606_4B50
  static let zip64EOCDLocatorStructSignature = 0x0706_4B50
}
