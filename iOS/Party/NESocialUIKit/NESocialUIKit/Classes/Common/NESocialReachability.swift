...
public enum NESocialReachabilityError: Error {
...
public extension Notification.Name {
  static let reachabilityChanged = Notification.Name("NESocialReachabilityChanged")
}

public class NESocialReachability {
  public typealias NetworkReachable = (NESocialReachability) -> Void
  public typealias NetworkUnreachable = (NESocialReachability) -> Void
  ...
  public convenience init(hostname: String,
    ...
    guard let ref = SCNetworkReachabilityCreateWithName(nil, hostname) else {
      throw NESocialReachabilityError.failedToCreateWithHostname(hostname, SCError())
    }
  ...
  public convenience init(queueQoS: DispatchQoS = .default,
    ...
    guard let ref = SCNetworkReachabilityCreateWithAddress(nil, &zeroAddress) else {
      throw NESocialReachabilityError.failedToCreateWithAddress(zeroAddress, SCError())
    }
...
public extension NESocialReachability {
  ...
  func startNotifier() throws {
    ...
    if !SCNetworkReachabilitySetCallback(reachabilityRef, callback, &context) {
      stopNotifier()
      throw NESocialReachabilityError.unableToSetCallback(SCError())
    }

    if !SCNetworkReachabilitySetDispatchQueue(reachabilityRef, reachabilitySerialQueue) {
      stopNotifier()
      throw NESocialReachabilityError.unableToSetDispatchQueue(SCError())
    }
...
private extension NESocialReachability {
  func setReachabilityFlags() throws {
    try reachabilitySerialQueue.sync { [unowned self] in
      var flags = SCNetworkReachabilityFlags()
      if !SCNetworkReachabilityGetFlags(reachabilityRef, &flags) {
        stopNotifier()
        throw NESocialReachabilityError.unableToGetFlags(SCError())
      }
...
extension SCNetworkReachabilityFlags {
  typealias Connection = NESocialReachability.Connection
...
private class ReachabilityWeakifier {
  weak var reachability: NESocialReachability?
  init(reachability: NESocialReachability) {
