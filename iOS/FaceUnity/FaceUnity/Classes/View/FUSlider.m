...
- (void)configureUI {
  [self setThumbImage:[UIImage imageNamed:@"expource_slider_dot" inBundle:[NSBundle bundleForClass:self.class] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
...
- (UIImageView *)tipBackgroundImageView {
  if (!_tipBackgroundImageView) {
    UIImage *bgImage = [UIImage imageNamed:@"slider_tip_bg" inBundle:[NSBundle bundleForClass:self.class] compatibleWithTraitCollection:nil];
