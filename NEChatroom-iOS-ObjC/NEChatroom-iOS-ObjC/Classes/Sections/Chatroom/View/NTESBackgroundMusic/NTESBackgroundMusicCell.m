...
@implementation NTESBackgroundMusicCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.indexLabel.textColor = [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1.0];
        ...
        self.textLabel.textColor = [UIColor colorWithRed:34/255.0 green:34/255.0 blue:34/255.0 alpha:1.0];
...
- (void)layoutSubviews {
    ...
    self.textLabel.frame = CGRectMake(CGRectGetMaxX(self.indexLabel.frame)+8, 8, self.contentView.frame.size.width-CGRectGetMaxX(self.indexLabel.frame)-8-20*2, 22);
    self.detailTextLabel.frame = CGRectMake(self.textLabel.frame.origin.x, CGRectGetMaxY(self.textLabel.frame), self.textLabel.frame.size.width, 18);
}
