...
@interface NTESChatRoomListViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)ntes_getNewData {
    ...
    [self.liveListViewModel loadNewDataWithLiveType:NTESCreateRoomTypeChatRoom];
}
...
- (void)ntes_addSubViews {
    ...
    self.collectionView.mj_footer = [MJRefreshBackNormalFooter footerWithRefreshingBlock:^{
        ...
        if (self.liveListViewModel.isEnd) {
            ...
            [self.liveListViewModel loadMoreWithLiveType:NTESCreateRoomTypeChatRoom];
        }
    }];
}
...
- (void)createChatRoomAction {
    NTESOpenRoomViewController *chatRoomCtrl = [[NTESOpenRoomViewController alloc] initWithRoomType:NTESCreateRoomTypeChatRoom];
