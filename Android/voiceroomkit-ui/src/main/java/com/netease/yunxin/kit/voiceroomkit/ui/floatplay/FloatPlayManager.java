...
public class FloatPlayManager {
  ...
  private VoiceRoomModel voiceRoomInfo;
  ...
  public void startFloatPlay(Context context, VoiceRoomModel voiceRoomInfo, Intent intent) {
  ...
  public VoiceRoomModel getVoiceRoomInfo() {
