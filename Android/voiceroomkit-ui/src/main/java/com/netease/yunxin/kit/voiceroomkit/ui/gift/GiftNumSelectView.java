...
public class GiftNumSelectView extends RecyclerView {
  ...
  public GiftNumSelectView(@NonNull Context context) {
    super(context);
    init(context);
  }

  public GiftNumSelectView(@NonNull Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    init(context);
  }

  public GiftNumSelectView(
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      return new GiftNumberSelectHolder(
          LayoutInflater.from(parent.getContext())
              .inflate(R.layout.voiceroom_item_gift_num_select, parent, false));
    }
