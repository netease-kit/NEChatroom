    ...
    companion object {
        fun fromValue(value: String?): NEVoiceRoomEndReason = when (value) {
            ...
            END_OF_RTC.name -> END_OF_RTC
                ...
                ListenTogetherLog.e("NEVoiceRoomEndReason", "parse failure， Unable to identify: $value")
                UNKNOWN
            }
        }
    }
    ...
    companion object {
        fun fromValue(value: String?): NEVoiceRoomAuthEvent = when (value) {
            ...
            LOGGED_OUT.name -> LOGGED_OUT
                ...
                ListenTogetherLog.e("NEVoiceRoomAuthEvent", "parse failure， Unable to identify: $value")
                LOGGED_OUT
            }
        }
    }
