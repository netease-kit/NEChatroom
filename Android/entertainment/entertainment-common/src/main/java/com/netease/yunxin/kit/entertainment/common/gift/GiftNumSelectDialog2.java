...
public class GiftNumSelectDialog2 extends Dialog {
  ...
  public GiftNumSelectDialog2(@NonNull Context context, GiftNumSelectCallback callback) {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    GiftNumSelectView2 giftNumSelectView = findViewById(R.id.gift_number_select);
