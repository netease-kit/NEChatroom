...
/** 送礼头像选择 */
public class SelectMemberSendGiftView2 extends RecyclerView {
  ...
  public SelectMemberSendGiftView2(@NonNull Context context) {
    super(context);
    init(context);
  }

  public SelectMemberSendGiftView2(@NonNull Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    init(context);
  }

  public SelectMemberSendGiftView2(
