...
public class DiskLogStrategy implements LogStrategy {
    ...
    public DiskLogStrategy(Context context) {
        HandlerThread ht = new HandlerThread("LoggerHandlerThread");
        ht.start();
        File dir = context.getExternalFilesDir("log");
        dir.mkdirs();
        this.handler = new WriteHandler(ht.getLooper(), dir.getAbsolutePath(), Integer.MAX_VALUE);
    }
    ...
    static class WriteHandler extends Handler {
        ...
        @Override public void handleMessage(@NonNull Message msg) {
            ...
            File logFile = getLogFile(folder, "app");
