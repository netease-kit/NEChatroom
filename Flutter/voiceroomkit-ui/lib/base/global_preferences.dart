...
class GlobalPreferences extends Preferences {
  ...
  static const String keyDataCenter = "dataCenter";
  ...
  Future<void> setDataCenter(int dataCenter) async {
    setIntSp(keyDataCenter, dataCenter);
  }

  Future<int?> get dataCenter async {
    return getIntSp(keyDataCenter);
  }
